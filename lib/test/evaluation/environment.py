...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.davis_dir = ''
        self.youtubevos_dir = ''
        self.uavdt_path = os.path.join(data_dir, 'uavdt')
        self.dtb70_path = os.path.join(data_dir, 'DTB70')
        self.visdrone_path = os.path.join(data_dir, 'VisDrone2018-SOT-test-dev')
        self.uavtrack_path = os.path.join(data_dir, 'V4RFlight112')
        self.uav123_path = os.path.join(data_dir, 'UAV123')
        self.uav123_10fps_path = os.path.join(data_dir, 'UAV123_10fps')
        self.webuav3m_path = os.path.join(data_dir, 'WebUAV-3M/Test')
