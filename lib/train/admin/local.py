class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = '/public/zhongbineng/workspaces/xcc25/TPAMI/LETrack'    # Base directory for saving network checkpoints.
        self.tensorboard_dir = '/public/zhongbineng/workspaces/xcc25/TPAMI/LETrack/tensorboard'    # Directory for tensorboard files.
        self.pretrained_networks = '/public/zhongbineng/workspaces/xcc25/TPAMI/LETrack/pretrained_networks'
