...
class BaseTrainer:
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        legacy_net_types = {'LETrack': ['ODTrack']}
        compatible_net_types = [net_type] + legacy_net_types.get(net_type, [])
        assert checkpoint_dict['net_type'] in compatible_net_types, 'Network is not of correct type.'
