...
class LETrackActor(BaseActor):
    """ Actor for training LETrack models """
    ...
    def compute_losses(self, pred_dict, gt_dict, return_status=True):
        ...
        for i in range(len(pred_dict)):
            ...
            # cos loss
            # cos_tensor = pred_dict[i]['cos_tensor']
            ...
            # loss_dict['cos'] = pro_loss
            # self.loss_weight['cos'] = 0.2
            # weighted sum
            ...
            if return_status:
                ...
                status = {f"{i}frame_Loss/total": loss.item(),
                        ...
                        # f"{i}frame_Loss/cos": pro_loss.item(),
